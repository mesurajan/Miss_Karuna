        ...
        const cardData = [
            ...
            { 
                frontImage: "Images/11.png", 
                type: "image"
            },
            { 
                frontImage: "Images/10.png", 
                type: "image"
            },
            { 
                frontImage: "Images/09.png", 
                type: "image"
            },
            { 
                frontImage: "Images/08.png", 
                type: "message",
                message: "You make my heart smile every day! ❤️"
            },
            { 
                frontImage: "Images/07.png", 
                type: "image" 
            },
            { 
                frontImage: "Images/06.png", 
                type: "gif",
                gifUrl: "/api/placeholder/400/320",
                caption: "You're my favorite person!"
            },
            { 
                frontImage: "Images/05.png", 
                type: "image" 
            },
            { 
                frontImage: "Images/04.png", 
                type: "message",
                message: "I love the way your eyes crinkle when you laugh! 😊"
            },
            { 
                frontImage: "Images/03.png", 
                type: "image" 
            },
            { 
                frontImage: "Images/02.png", 
                type: "gif",
                gifUrl: "/api/placeholder/400/320",
                caption: "You're the cutest!"
            },
            { 
                frontImage: "Images/01.png", 
                type: "message",
